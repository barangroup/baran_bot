...
var q = "۱-نحوه ى عضويت شمادرگروه باران به شکل بوده است؟\n" +
	"۲-از چه سالى فعاليت خود را در گروه آغازکرديد؟\n" +
	"۳-چه انگيزه اى باعث شده در باران فعالیت بیشتری داشته باشید؟\n" +
	"۴-اگر به شمادرگروه مسئوليتى داده شود دوست داريدآن مسئوليت چه باشد؟ وايده خودرا درباره آن بگوييد.\n" +
...
api.on('message', function(message) {
	...
	} else if (Number(income_text.charAt(0)) == income_text.charAt(0)) {
		db.poll.findOne({
			username: username
		}, function(err, user) {
			if (err) {
